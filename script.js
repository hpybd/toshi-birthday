...
const LTCA_TYPE_LINE = "You have a presence people feel — and that’s your superpower.";
...
function resetAll(){
  ...
  $("#affirmText").textContent = "“You don’t need to do the most to be unforgettable.”";
...
const letterSteps = [
...

  {
    kind: "text",
    getText: (mood) => [
      `You’re funny. You’re full of life. You’re chaotic in the best way.`,
...
const affirmations = [
  ...
  `Your energy is fun. Your quiet is precious. Both are you.`,
